...
// Add your trips and photos here - it's that easy!
...
export const GALLERY_TRIPS = [
  ...
  // {
  //   id: 'grand-canyon-2023',
  //   title: 'Grand Canyon',
  //   date: 'Summer 2023',
  //   description: 'Exploring the vast beauty of the Grand Canyon',
  //   coverImage: '/images/gallery/grand-canyon/cover.jpg',
  //   photos: [...]
  // },
];